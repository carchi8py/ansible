...
class NetAppOntapVolumeAutosize(object):
    ...
    def modify_volume_autosize(self):
        """
    ...
    def modify_to_kb(self, converted_parameters):
        ...
        :return:
        """
        if converted_parameters.get('maximum_size'):
            converted_parameters['maximum_size'] = str(self.convert_to_kb('maximum_size', converted_parameters))
        if converted_parameters.get('minimum_size'):
            converted_parameters['minimum_size'] = str(self.convert_to_kb('minimum_size', converted_parameters))
        if converted_parameters.get('increment_size'):
            converted_parameters['increment_size'] = str(self.convert_to_kb('increment_size', converted_parameters))
